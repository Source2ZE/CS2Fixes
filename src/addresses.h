...
inline void(FASTCALL* CEntitySystem_AddEntityIOEvent)(CEntitySystem*   pEntitySystem,
													  CEntityInstance* pTarget, const char* pszInput,
...
inline void(FASTCALL* CEntityInstance_AcceptInput)(CEntityInstance* pThis,
...
inline CBaseEntity*(FASTCALL* CGameEntitySystem_FindEntityByName)(CEntitySystem*   pEntitySystem,
																  CEntityInstance* pStartEntity, const char* szName,
																  CEntityInstance*	 pSearchingEntity,
																  CEntityInstance*	 pActivator,
																  CEntityInstance*	 pCaller,
...
inline int(FASTCALL* DispatchParticleEffect)(const char* pszParticleName,
											 int iAttachType, CBaseEntity* pEntity,
...
inline void(FASTCALL* CTakeDamageInfo_Constructor)(CTakeDamageInfo* pThis,
												   CBaseEntity*		pInflictor,
												   CBaseEntity*		pAttacker,
												   CBaseEntity*		pAbility,
												   const Vector*	vecDamageForce,
												   const Vector*	vecDamagePosition,
												   float			flDamage,
												   int				bitsDamageType,
												   int				iCustomDamage,
												   void*			a10);
